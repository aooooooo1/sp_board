...
public interface MemberDAO {
	...
	void updateMember(MemberVO member) throws SQLException;
	 ...
	 void selectMemberDelete(String id) throws SQLException;

	void selectMemberStop(String id) throws SQLException;

	void selectMemberRerole(String id) throws SQLException;
