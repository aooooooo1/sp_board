		...
		<div class="register-box" style="min-width: 450px;">
			...
			<div class="card">
				<div class="register-card-body">
					<form role="form" class="form-horizontal" method="post" action="delete.do">
						<!-- 프로필 사진 선택 부분 -->
						<div class="row">
						...
						<div class="card-footer">
							<div class="row">
								...
								<c:set var="visible" value="none"/>  <!-- var에서 설정한 값이 none으로 바뀜 -->
								...
								<div class="col-sm-3 text-center">
									<button type="button" id="stopBtn" class="btn btn-info" style="display : ${visible};">${member.enabled == 1 ? '정지' : '해제'} </button>
								</div>
								<div class="col-sm-3 text-center">
